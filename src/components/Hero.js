...
const Hero = () => {
  return (
    <section
      className="relative bg-cover bg-primary bg-center h-screen"
    ...
    >
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white text-center px-6 md:px-12">
        ...
        <p className="text-lg md:text-2xl max-w-3xl mx-auto mb-8 drop-shadow-md">
          Transform your space with our bespoke interior designs. Experience
        ...
        <div className="mt-8 space-x-4 flex flex-col sm:flex-row justify-center">
          ...
          <a href={"#gallary"}>
            <button className="bg-primary text-black hover:bg-focus hover:scale-105 transition transform duration-300 px-8 py-4 rounded-full font-semibold shadow-lg focus:outline-none">
              View Portfolio
            </button>
          </a>
